...
@SuppressLint("NewApi") public class Events extends Activity implements OnMenuItemClickListener  {
        ...
        lstView.setAdapter(imageAdapter);
     		...
     		lstView.setOnItemClickListener(new OnItemClickListener() {
      			...
      			String sTitle = MyArrList.get(position).get("Title")
    					.toString();
    			String sTime = MyArrList.get(position).get("Time")
    					.toString();
    				String sDate = MyArrList.get(position).get("Date")
    				.toString();
      	             Intent newActivity = new Intent(Events.this,EventDetails.class);
      				newActivity.putExtra("MemberID", sMemberID);
      			    newActivity.putExtra("Title", sTitle);
      				newActivity.putExtra("Time", sTime);
      				newActivity.putExtra("Date", sDate);
    ...
    class LoadContentFromServer extends AsyncTask<Object, Integer, Object> {
        ...
        protected Object doInBackground(Object... params) {
        	...
        	String url = "http://noticeb.net46.net/getEvent.php";
    ...
    class ImageAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				convertView = inflater.inflate(R.layout.event_column, null); 
			}
		...
		txtDate.setPadding(0, 0, 0, 0);
		txtDate.setText(""+MyArrList.get(position).get("Date"));
		
		// ColDesignation
		TextView txtTime = (TextView) convertView.findViewById(R.id.time);
		txtTime.setPadding(0, 0, 0, 0);
		txtTime.setText(""+ MyArrList.get(position).get("Time"));
		
		// ColDesignation
		TextView txtPicName = (TextView) convertView.findViewById(R.id.title);
		txtPicName.setPadding(10, 0, 0, 0);
		txtPicName.setText(""+ MyArrList.get(position).get("Title"));
    ...
    public boolean onMenuItemClick(MenuItem item) {
          ...
          case R.id.item_about:
        	  Intent j11 =new Intent(Events.this, com.geca.compsa.about.AboutUsDev.class);
              startActivity(j11);
              break;
